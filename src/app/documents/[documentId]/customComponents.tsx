        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent className="min-w-7">
                    <DropdownMenuItem onClick={onUpload} className="flex flex-row items-center">
                        <UploadIcon className="size-4 mr-2" />
                        Upload
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setIsDialogOpen(true)} className="flex flex-row items-center">
